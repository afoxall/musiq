...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private void updateAlpha() {
        ...
        alpha1.setText(String.format("%6.2f", alphaBuffer[0]));
        TextView alpha2 = (TextView)findViewById(R.id.alpha2);
        alpha2.setText(String.format("%6.2f", alphaBuffer[1]));
        TextView alpha3 = (TextView)findViewById(R.id.alpha3);
        alpha3.setText(String.format("%6.2f", alphaBuffer[2]));
        TextView alpha4 = (TextView)findViewById(R.id.alpha4);
        alpha4.setText(String.format("%6.2f", alphaBuffer[3]));
    }
    ...
    private void updateTheta() {
        ...
        theta1.setText(String.format("%6.2f", betaBuffer[0]));
        TextView theta2 = (TextView)findViewById(R.id.theta2);
        theta2.setText(String.format("%6.2f", betaBuffer[1]));
        TextView theta3 = (TextView)findViewById(R.id.theta3);
        theta3.setText(String.format("%6.2f", betaBuffer[2]));
